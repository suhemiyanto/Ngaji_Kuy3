...
public class FormulirDaftarActivity extends AppCompatActivity /*implements View.OnClickListener*/ {
    ...
    public void registrasi(View view) {
        ...
        mail = emaildaftar.getText().toString();
        pw = passworddaftar.getText().toString();
        nama = daftarnama.getText().toString();
        jk = daftarjk.getText().toString();
        hp = daftarhp.getText().toString();
        alamat = daftaralamat.getText().toString();
